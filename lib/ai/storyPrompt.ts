/**
 * This is the exact system instruction your latest ai-generate.php sends
 * to Gemini, copied verbatim rather than paraphrased -- it's a precise
 * content spec (word counts, formatting rules, safety rules) where
 * rewording risks silently changing the output your team is used to.
 */
